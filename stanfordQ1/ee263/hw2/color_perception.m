...
P = [B_phosphor; G_phosphor; R_phosphor]';
B = A*P;
coeff = B^-1*A*test_light;

% the weights obtained for B, G, R are 0.53, 0.99, 0.42, respectively
...
r1 = ones(20,1)*0.1;
Iw = diag(tungsten);
r2 = linsolve(A*Iw,A*Iw*r1);

Is = diag(sunlight);
figure; subplot(2,1,1);
plot(A*Iw*r1,'ob'); hold on; plot(A*Iw*r2,'*red');
title('Human perception of two objects illuminated by tungsten');
legend('Object 1', 'Object 2');

subplot(2,1,2);
plot(A*Is*r1, 'ob'); hold on; plot(A*Is*r2,'*r');
title('Human perception of two objects illuminated by sunlight');
legend('Object 1', 'Object 2');
